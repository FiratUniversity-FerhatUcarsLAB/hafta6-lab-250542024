...
public class NotSistemi {
    ...
    public static boolean isHonorList(double ortalama, int vize_notu, int final_notu, int odev_notu){
        ...
        if(ortalama >= 85 && vize_notu >= 70 
             && final_notu >= 70 && odev_notu >= 70){
                 return true;
             }else{
                 return false;
             }
    ...
    public static void main(String[] args) {
        ...
        System.err.println("Onur Listesi : " +(isHonorList(ortalama, vize_notu, final_notu, odev_notu)== true? "EVET" : "HAYIR"));
        System.err.println("Bütünleme : " +(hasRetakeRight(ortalama)== true? "VAR" : "YOK" ));
